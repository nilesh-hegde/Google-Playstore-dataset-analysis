...
def deleting():
    if request.method == 'POST':
        ...
        dt = db.cleandata.delete_many(query)
        return '''<p>{} records deleted<p>'''.format(dt.deleted_count)
        ...
        <header class="w3-container w3-center w3-padding-32">
          <h1><b>CRUD Operations : DELETION</b></h1>
          <p>Welcome to the Query Page of <span class="w3-tag">Google PlayStore Dataset</span></p>
        </header>
        <form method="POST">
        <pre align = "center">
        Delete <input type="text" name="data"></pre>
        <pre align = "center"><input type="submit" class = "button" value="Delete"></pre>
